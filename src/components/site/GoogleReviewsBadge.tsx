...
export function GoogleReviewsBadge({
  ...
  return (
    <a
      ...
      className={`inline-flex min-h-[44px] items-center gap-2 border border-white/10 bg-ink px-4 py-2 text-sm text-cream transition hover:border-brand ${className}`}
    >
