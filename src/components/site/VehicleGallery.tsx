...
/**
 * Galeria em faixa horizontal (snap). Miniaturas só no desktop,
 * para a primeira dobra do celular caber na tela.
 * A proporção 16/10 fica reservada no desktop para não pular o layout.
 */
export function VehicleGallery({
  ...
  if (total === 0) {
    return (
      <div className="gallery-root flex h-full min-h-0 flex-col">
        <div className="gallery-frame relative min-h-[9rem] flex-1 overflow-hidden border border-white/10 bg-ink lg:aspect-[16/10] lg:min-h-0 lg:flex-none">
          <VehicleImage
            src={null}
            alt={alt}
            fill
