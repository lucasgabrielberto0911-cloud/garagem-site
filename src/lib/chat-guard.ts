...
const GARAGE_HINT =
  /\b(carro|carros|moto|veiculo|estoque|seminovo|comprar|compra|vender|vende|vendem|troca|financi\w*|parcela|juros|cartao|credito|pix|vista|18x|60x|garantia|horario|atendimento|whatsapp|garagem|loja|endereco|localizacao|entrega|visita|video|documento|documentacao|transferencia|detran|despachante|hb20|onix|civic|corolla|palio|prisma|kwid|mobi|argo|polo|creta|compass|renegade|hilux|s10|amarok|ranger|honda|fiat|hyundai|chevrolet|toyota|volkswagen|vw|nissan|ford|jeep|porsche|km|preco|valor|tem|modelo|marca|anunciar|blindad\w*|disponivel|anuncio|consultor|vendedor|telefone|celular|contato|nome)\b/;
